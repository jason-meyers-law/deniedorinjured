...
| Firm details | `packages/site/src/data/firm.json` | Firm name and the line under it, legal name, principal attorney, phone, email, office address, area served, office hours. Drives the header, footer, contact page (including the map), and structured data. |
